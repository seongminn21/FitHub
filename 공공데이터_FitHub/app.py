...
FILE_PATH = r"C:\Users\seong\OneDrive\바탕 화면\공공데이터_웹_중간중간중간\user_data.csv" # 경로 수정 필요
...
# 데이터 불러오기 및 전처리
data = pd.read_csv("C:/Users/seong/OneDrive/바탕 화면/올림픽수영장 강좌정보.csv", encoding='cp949') # 경로 수정 필요
